...
camel export * \
--runtime=quarkus \
--gav=vw.man.poc:postgresql-to-mqtt-and-file:1.0.0 \
...
echo "%prod.quarkus.kubernetes-config.secrets=mqtt-secret,postgresql-secret" >> ./ceq/src/main/resources/application.properties
